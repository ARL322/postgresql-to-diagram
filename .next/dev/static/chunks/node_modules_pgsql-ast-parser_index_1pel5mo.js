...
"[project]/node_modules/pgsql-ast-parser/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
(function(e, a) {
    ...
    /******/ __webpack_require__.t = function(value1, mode) {
        /******/ if (mode & 1) value1 = __webpack_require__(value1);
        /******/ if (mode & 8) return value1;
        /******/ if (mode & 4 && typeof value1 === 'object' && value1 && value1.__esModule) return value1;
        ...
        /******/ if (mode & 2 && typeof value1 != 'string') for(var key in value1)__webpack_require__.d(ns, key, (function(key) {
            return value1[key];
        }).bind(null, key));
        /******/ return ns;
    /******/ };
...
/******/ }([
    function(module, exports1) {
        module.exports = __turbopack_context__.r("[project]/node_modules/moo/moo.js [app-client] (ecmascript)");
    /***/ },
    function(module, exports1, __webpack_require__) {
        ...
        exports1.unbox = exports1.doubleQuoted = exports1.box = exports1.track = exports1.tracking = exports1.trackingComments = exports1.lexerAny = exports1.lexer = void 0;
        ...
        // build lexer
        exports1.lexer = (0, moo_1.compile)({
            word: {
        ...
        exports1.lexer.next = ((next)=>()=>{
                let tok;
                let commentFull = null;
                while(tok = next.call(exports1.lexer)){
        ...
        exports1.lexerAny = exports1.lexer;
        let comments = null;
        ...
        exports1.trackingComments = trackingComments;
        ...
        function box(xs, value1, doubleQuoted) {
            if (!trackingLoc && !doubleQuoted) {
                return value1;
            }
            return track(xs, {
                [literal]: value1,
                [doubleQuotedSym]: doubleQuoted
            });
        }
        exports1.box = box;
        ...
        function doubleQuoted(value1) {
            const uw = unwrapNoBox(value1);
            if (typeof value1 === 'object' && (uw === null || uw === void 0 ? void 0 : uw[doubleQuotedSym])) {
                return {
                    doubleQuoted: true
                };
            }
        ...
        exports1.doubleQuoted = doubleQuoted;
        function unbox(value1) {
            var _a;
            if (typeof value1 === 'object') {
                return (_a = value1 === null || value1 === void 0 ? void 0 : value1[literal]) !== null && _a !== void 0 ? _a : value1;
            }
            return value1;
        }
        exports1.unbox = unbox;
    ...
    function(module, exports1, __webpack_require__) {
        ...
        exports1.AstDefaultMapper = exports1.arrayNilMap = exports1.assignChanged = exports1.astMapper = void 0;
 ...
 */ function assignChanged(orig, assign) {
        ...
        exports1.assignChanged = assignChanged;
        /**
 ...
 */ function arrayNilMap(collection, mapper) {
        ...
        exports1.arrayNilMap = arrayNilMap;
 ...
 */ class AstDefaultMapper {
            ...
            set(st) {
                const value1 = this.expr(st.value);
                if (!value1) {
                    return null;
                }
            ...
            // ================ STUFF ==================
            // =========================================
            /** Called when a data type definition is encountered */ dataType(dataType) {
                return dataType;
            }
            /** Called when an alias of a table is created */ tableRef(st) {
                return st;
            }
            transaction(val) {
                return val;
            ...
            ternary(val) {
                const value1 = this.expr(val.value);
            ...
            case(val) {
                ...
                const whens = arrayNilMap(val.whens, (w)=>{
                    ...
                    const value1 = this.expr(w.value);
                    if (!when || !value1) {
                        return null;
                    }
            ...
            call(val) {
                ...
                const withinGroupList = val.withinGroup ? [
                    val.withinGroup
                ] : undefined;
            ...
            /** Called when a reference is used */ ref(val) {
                return val;
            }
            unary(val) {
                const operand = this.expr(val.operand);
        ...
        exports1.AstDefaultMapper = AstDefaultMapper;
    ...
    function(module, exports1, __webpack_require__) {
        ...
        exports1.intervalToString = exports1.normalizeInterval = exports1.buildInterval = void 0;
        const types = [
            [
                'years',
                12
        ...
        exports1.buildInterval = buildInterval;
        /** Returns a normalized copy of the given interval */ function normalizeInterval(value1) {
            ...
            for(let i = 0; i < types.length; i++){
                ...
                const int1 = v >= 0 ? Math.floor(v) : Math.ceil(v);
                if (!v || int1 === v) {
                    continue;
                }
                const nk = (_b = types[i + 1]) === null || _b === void 0 ? void 0 : _b[0];
                if (nk) {
                    ret[nk] = ((_c = ret[nk]) !== null && _c !== void 0 ? _c : 0) + mul * (v - int1);
                }
                ret[k] = int1;
            }
            ...
            // normalize time
            let t = ((_f = ret.hours) !== null && _f !== void 0 ? _f : 0) * 3600 + ((_g = ret.minutes) !== null && _g !== void 0 ? _g : 0) * 60 + ((_h = ret.seconds) !== null && _h !== void 0 ? _h : 0) + ((_j = ret.milliseconds) !== null && _j !== void 0 ? _j : 0) / 1000;
            let sign = 1;
            if (t < 0) {
                sign = -1;
                t = -t;
        ...
        exports1.normalizeInterval = normalizeInterval;
        /** Interval value to postgres string representation  */ function intervalToString(value1) {
            var _a, _b, _c;
            value1 = normalizeInterval(value1);
            const ret = [];
            if (value1.years) {
                ret.push(value1.years === 1 ? '1 year' : value1.years + ' years');
            }
            if (value1.months) {
                ret.push(value1.months === 1 ? '1 month' : value1.months + ' months');
            }
            if (value1.days) {
                ret.push(value1.days === 1 ? '1 day' : value1.days + ' days');
            }
            if (value1.hours || value1.minutes || value1.seconds || value1.milliseconds) {
                let time = `${num((_a = value1.hours) !== null && _a !== void 0 ? _a : 0)}:${num((_b = value1.minutes) !== null && _b !== void 0 ? _b : 0)}:${num((_c = value1.seconds) !== null && _c !== void 0 ? _c : 0)}`;
                if (value1.milliseconds) {
                    time = time + (value1.milliseconds / 1000).toString().substr(1);
                }
                if (neg1(value1.hours) || neg1(value1.minutes) || neg1(value1.seconds) || neg1(value1.milliseconds)) {
                    time = '-' + time;
                }
                ret.push(time);
            }
        ...
        exports1.intervalToString = intervalToString;
        function num(v) {
            v = Math.abs(v);
 ...
 */ function astVisitor(visitorBuilder) {
        ...
        exports1.astVisitor = astVisitor;
    /***/ },
    function(module, exports1, __webpack_require__) {
        "use strict";
        Object.defineProperty(exports1, "__esModule", {
        ...
        exports1.trimNullish = exports1.NotSupported = void 0;
        class NotSupported extends Error {
            constructor(what){
                super('Not supported' + (what ? ': ' + what : ''));
            }
            static never(value1, msg) {
                return new NotSupported(`${msg !== null && msg !== void 0 ? msg : ''} ${JSON.stringify(value1)}`);
            }
        }
        exports1.NotSupported = NotSupported;
        function trimNullish(value1, depth = 5) {
            if (depth < 0) return value1;
            if (value1 instanceof Array) {
                value1.forEach((x)=>trimNullish(x, depth - 1));
            }
            if (typeof value1 !== 'object' || value1 instanceof Date) return value1;
            if (!value1) {
                return value1;
            }
            for (const k of Object.keys(value1)){
                const val = value1[k];
                if (val === undefined || val === null) delete value1[k];
                else trimNullish(val, depth - 1);
            }
            return value1;
        }
        exports1.trimNullish = trimNullish;
    /***/ },
    function(module, exports1, __webpack_require__) {
        "use strict";
        ...
        exports1.normalizeInterval = exports1.intervalToString = exports1.toSql = exports1.astMapper = exports1.assignChanged = exports1.arrayNilMap = exports1.astVisitor = exports1.parseWithComments = exports1.parseIntervalLiteral = exports1.parseGeometricLiteral = exports1.parseArrayLiteral = exports1.parseFirst = exports1.parse = void 0;
        ...
        Object.defineProperty(exports1, "parseFirst", {
            enumerable: true,
            get: function() {
                return parser_1.parseFirst;
            }
        });
        Object.defineProperty(exports1, "parseArrayLiteral", {
            enumerable: true,
            get: function() {
                return parser_1.parseArrayLiteral;
            }
        });
        Object.defineProperty(exports1, "parseGeometricLiteral", {
            enumerable: true,
            get: function() {
                return parser_1.parseGeometricLiteral;
            }
        });
        Object.defineProperty(exports1, "parseIntervalLiteral", {
            enumerable: true,
            get: function() {
                return parser_1.parseIntervalLiteral;
            }
        });
        Object.defineProperty(exports1, "parseWithComments", {
            enumerable: true,
            get: function() {
        ...
        Object.defineProperty(exports1, "astVisitor", {
            enumerable: true,
            get: function() {
        ...
        Object.defineProperty(exports1, "arrayNilMap", {
            enumerable: true,
            get: function() {
                return ast_mapper_1.arrayNilMap;
            }
        });
        Object.defineProperty(exports1, "assignChanged", {
            enumerable: true,
            get: function() {
                return ast_mapper_1.assignChanged;
            }
        });
        Object.defineProperty(exports1, "astMapper", {
            enumerable: true,
            get: function() {
        ...
        Object.defineProperty(exports1, "toSql", {
            enumerable: true,
            get: function() {
                return to_sql_1.toSql;
            }
        });
        __exportStar(__webpack_require__(21), exports1);
        var interval_builder_1 = __webpack_require__(4);
        Object.defineProperty(exports1, "intervalToString", {
            enumerable: true,
            get: function() {
                return interval_builder_1.intervalToString;
            }
        });
        Object.defineProperty(exports1, "normalizeInterval", {
            enumerable: true,
            get: function() {
    ...
    function(module, exports1, __webpack_require__) {
        ...
        exports1.parseGeometricLiteral = exports1.parseIntervalLiteral = exports1.parseArrayLiteral = exports1.parse = exports1.parseWithComments = exports1.parseFirst = void 0;
        ...
        /** Parse the first SQL statement in the given text (discards the rest), and return its AST */ function parseFirst(sql) {
            const first = parse(sql);
            return first[0];
        }
        exports1.parseFirst = parseFirst;
        /** Parse an AST from SQL, and get the comments */ function parseWithComments(sql, options) {
            return (0, lexer_1.trackingComments)(()=>parse(sql, options));
        }
        exports1.parseWithComments = parseWithComments;
        ...
        exports1.parseArrayLiteral = parseArrayLiteral;
        ...
        exports1.parseIntervalLiteral = parseIntervalLiteral;
        ...
        exports1.parseGeometricLiteral = parseGeometricLiteral;
    ...
    /***/ },
    function(module, exports1) {
        module.exports = __turbopack_context__.r("[project]/node_modules/nearley/lib/nearley.js [app-client] (ecmascript)");
    /***/ },
    function(module, exports1, __webpack_require__) {
        "use strict";
        Object.defineProperty(exports1, "__esModule", {
        ...
        function asStr(value1) {
            var _a;
            value1 = (0, lexer_2.unbox)(value1);
            return (_a = value1 === null || value1 === void 0 ? void 0 : value1.value) !== null && _a !== void 0 ? _a : value1;
        }
        ...
        const grammar = {
            ...
            ParserRules: [
                ...
                },
                {
                    "name": "float",
                    "symbols": [
                        lexer_1.lexerAny.has("float") ? {
                            type: "float"
                        } : float
                    ],
                    "postprocess": (x)=>(0, lexer_2.box)(x, parseFloat(unwrap(x)))
                },
                {
                    "name": "int",
                    "symbols": [
                        lexer_1.lexerAny.has("int") ? {
                            type: "int"
                        } : int
                    ],
                    "postprocess": (x)=>(0, lexer_2.box)(x, parseInt(unwrap(x), 10))
                },
                {
                    "name": "comma",
                    "symbols": [
                        lexer_1.lexerAny.has("comma") ? {
                            type: "comma"
                        } : comma
                    ],
                    "postprocess": id
                },
                {
                    "name": "star",
                    "symbols": [
                        lexer_1.lexerAny.has("star") ? {
                            type: "star"
                        } : star
                    ],
                    "postprocess": (x)=>(0, lexer_2.box)(x, x[0].value)
                },
                {
                    "name": "string$subexpression$1",
                    "symbols": [
                        lexer_1.lexerAny.has("string") ? {
                            type: "string"
                        } : string
                    ]
                },
                ...
                },
                {
                    ...
                    "postprocess": (x)=>(0, lexer_2.box)(x, unwrap(x[0]).value)
                },
                {
                    "name": "ident",
                    "symbols": [
                ...
                },
                {
                    "name": "word",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_primary") ? {
                            type: "kw_primary"
                        } : kw_primary
                    ],
                    "postprocess": (x)=>(0, lexer_2.box)(x, 'primary')
                },
                {
                    "name": "word",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_unique") ? {
                            type: "kw_unique"
                        } : kw_unique
                    ],
                    "postprocess": (x)=>(0, lexer_2.box)(x, 'unique')
                },
                {
                    "name": "word",
                    "symbols": [
                        lexer_1.lexerAny.has("quoted_word") ? {
                            type: "quoted_word"
                        } : quoted_word
                    ],
                    "postprocess": (x)=>(0, lexer_2.box)(x, x[0].value, true)
                },
                {
                    "name": "word",
                    "symbols": [
                        lexer_1.lexerAny.has("word") ? {
                            type: "word"
                        } : word
                    ],
                    "postprocess": (x)=>(0, lexer_2.box)(x, x[0].value)
                ...
                },
                {
                    ...
                    "postprocess": notReservedKw('trigger')
                },
                {
                    "name": "kw_delete",
                    "symbols": [
                ...
                },
                {
                    ...
                    "postprocess": notReservedKw('stored')
                },
                {
                    "name": "kw_cascaded",
                    "symbols": [
                ...
                },
                {
                    ...
                    "postprocess": notReservedKw('ordinality')
                },
                {
                    "name": "kw_overriding",
                    "symbols": [
                ...
                },
                {
                    ...
                    "postprocess": notReservedKw('names')
                },
                {
                    "name": "kw_at",
                    "symbols": [
                ...
                },
                {
                    ...
                    "postprocess": notReservedKw('session')
                },
                {
                    "name": "kw_prepare",
                    "symbols": [
                ...
                },
                {
                    ...
                    "postprocess": notReservedKw('nowait')
                },
                {
                    "name": "kw_skip",
                    "symbols": [
                    ...
                    "postprocess": notReservedKw('skip')
                },
                {
                    "name": "kw_locked",
                    "symbols": [
                    ...
                    "postprocess": notReservedKw('locked')
                },
                {
                    "name": "kw_within",
                    "symbols": [
                    ...
                    "postprocess": notReservedKw('within')
                },
                {
                    "name": "kw_ifnotexists",
                    "symbols": [
                        "kw_if",
                        lexer_1.lexerAny.has("kw_not") ? {
                            type: "kw_not"
                        } : kw_not,
                        "kw_exists"
                    ]
                ...
                {
                    "name": "kw_withordinality",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_with") ? {
                            type: "kw_with"
                        } : kw_with,
                        "kw_ordinality"
                    ]
                ...
                },
                {
                    ...
                    "symbols": [
                        lexer_1.lexerAny.has("lbracket") ? {
                            type: "lbracket"
                        } : lbracket,
                        lexer_1.lexerAny.has("rbracket") ? {
                            type: "rbracket"
                        } : rbracket
                    ]
                },
                ...
                },
                {
                    ...
                    "symbols": [
                        ...
                        lexer_1.lexerAny.has("kw_precision") ? {
                            type: "kw_precision"
                        } : kw_precision
                    ]
                },
                ...
                },
                {
                    "name": "qualified_name",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_current_schema") ? {
                ...
                {
                    "name": "qualified_name_mark_quotes",
                    "symbols": [
                        "qname_ident"
                    ],
                    "postprocess": (x)=>(0, lexer_2.track)(x, {
                            name: toStr(x),
                            ...(0, lexer_2.doubleQuoted)(x)
                        })
                },
                {
                    "name": "qualified_name_mark_quotes",
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_analyse") ? {
                            type: "kw_analyse"
                        } : kw_analyse
                    ]
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_analyze") ? {
                            type: "kw_analyze"
                        } : kw_analyze
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_asymmetric") ? {
                            type: "kw_asymmetric"
                        } : kw_asymmetric
                    ]
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_authorization") ? {
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_binary") ? {
                            type: "kw_binary"
                        } : kw_binary
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_collate") ? {
                            type: "kw_collate"
                        } : kw_collate
                    ]
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_collation") ? {
                            type: "kw_collation"
                        } : kw_collation
                    ]
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_concurrently") ? {
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_constraint") ? {
                            type: "kw_constraint"
                        } : kw_constraint
                    ]
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_create") ? {
                            type: "kw_create"
                        } : kw_create
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_current_catalog") ? {
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_current_date") ? {
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_current_role") ? {
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_current_time") ? {
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_current_timestamp") ? {
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_current_user") ? {
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_default") ? {
                            type: "kw_default"
                        } : kw_default
                    ]
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_deferrable") ? {
                            type: "kw_deferrable"
                        } : kw_deferrable
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_distinct") ? {
                            type: "kw_distinct"
                        } : kw_distinct
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_except") ? {
                            type: "kw_except"
                        } : kw_except
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_foreign") ? {
                            type: "kw_foreign"
                        } : kw_foreign
                    ]
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_freeze") ? {
                            type: "kw_freeze"
                        } : kw_freeze
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_having") ? {
                            type: "kw_having"
                        } : kw_having
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_initially") ? {
                            type: "kw_initially"
                        } : kw_initially
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_intersect") ? {
                            type: "kw_intersect"
                        } : kw_intersect
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_isnull") ? {
                            type: "kw_isnull"
                        } : kw_isnull
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_lateral") ? {
                            type: "kw_lateral"
                        } : kw_lateral
                    ]
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_leading") ? {
                            type: "kw_leading"
                        } : kw_leading
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_localtime") ? {
                            type: "kw_localtime"
                        } : kw_localtime
                    ]
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_localtimestamp") ? {
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_natural") ? {
                            type: "kw_natural"
                        } : kw_natural
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_notnull") ? {
                            type: "kw_notnull"
                        } : kw_notnull
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_offset") ? {
                            type: "kw_offset"
                        } : kw_offset
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_overlaps") ? {
                            type: "kw_overlaps"
                        } : kw_overlaps
                    ]
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_placing") ? {
                            type: "kw_placing"
                        } : kw_placing
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_references") ? {
                            type: "kw_references"
                        } : kw_references
                    ]
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_returning") ? {
                            type: "kw_returning"
                        } : kw_returning
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_select") ? {
                            type: "kw_select"
                        } : kw_select
                    ]
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_session_user") ? {
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_similar") ? {
                            type: "kw_similar"
                        } : kw_similar
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_symmetric") ? {
                            type: "kw_symmetric"
                        } : kw_symmetric
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_tablesample") ? {
                            type: "kw_tablesample"
                        } : kw_tablesample
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_trailing") ? {
                            type: "kw_trailing"
                        } : kw_trailing
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_variadic") ? {
                            type: "kw_variadic"
                        } : kw_variadic
                    ]
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_verbose") ? {
                            type: "kw_verbose"
                        } : kw_verbose
                    ]
                },
                ...
                },
                {
                    "name": "any_keyword",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_window") ? {
                            type: "kw_window"
                        } : kw_window
                    ]
                },
                ...
                {
                    "name": "select_statement$ebnf$3$subexpression$1$ebnf$1",
                    "symbols": [
                        "select_having"
                    ],
                    "postprocess": id
                ...
                {
                    "name": "select_statement$ebnf$3$subexpression$1",
                    "symbols": [
                        "select_groupby",
                        "select_statement$ebnf$3$subexpression$1$ebnf$1"
                    ]
                },
                {
                    "name": "select_statement$ebnf$3",
                    "symbols": [
                        "select_statement$ebnf$3$subexpression$1"
                    ],
                    "postprocess": id
                },
                {
                ...
                {
                    "name": "select_statement$ebnf$6$subexpression$1$ebnf$1",
                    "symbols": [
                        "select_skip"
                    ],
                    "postprocess": id
                ...
                {
                    "name": "select_statement$ebnf$6$subexpression$1",
                    "symbols": [
                        "select_for",
                        "select_statement$ebnf$6$subexpression$1$ebnf$1"
                    ]
                },
                {
                    "name": "select_statement$ebnf$6",
                    "symbols": [
                        "select_statement$ebnf$6$subexpression$1"
                    ],
                    "postprocess": id
                },
                {
                ...
                },
                {
                    ...
                    "postprocess": (x)=>(0, lexer_2.track)(x, {
                            alias: toStr(x[0]),
                            ...x[1] && {
                                columnNames: (0, lexer_2.unbox)(x[1]).map(asName)
                            }
                        })
                },
                {
                ...
                {
                    "name": "stb_call_alias$subexpression$1$ebnf$1",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_as") ? {
                            type: "kw_as"
                        } : kw_as
                ...
                {
                    "name": "stb_call_alias$subexpression$1",
                    "symbols": [
                        "stb_call_alias$subexpression$1$ebnf$1",
                        "ident"
                    ],
                    "postprocess": last
                },
                {
                    "name": "stb_call_alias$ebnf$1",
                    "symbols": [
                        "stb_call_alias_list"
                    ],
                    "postprocess": id
                ...
                },
                {
                    "name": "stb_call_alias",
                    "symbols": [
                        "stb_call_alias$subexpression$1",
                        "stb_call_alias$ebnf$1"
                    ]
                },
                {
                    "name": "stb_call_alias_list",
                    "symbols": [
                        "lparen",
                        "stb_call_alias_list_raw",
                        "rparen"
                    ],
                    "postprocess": get(1)
                },
                {
                    "name": "stb_call_alias_list_raw$ebnf$1",
                    "symbols": []
                },
                {
                    "name": "stb_call_alias_list_raw$ebnf$1$subexpression$1",
                    "symbols": [
                        "comma",
                        "ident"
                    ],
                ...
                },
                {
                    "name": "stb_call_alias_list_raw$ebnf$1",
                    "symbols": [
                        "stb_call_alias_list_raw$ebnf$1",
                        "stb_call_alias_list_raw$ebnf$1$subexpression$1"
                    ],
                    "postprocess": (d)=>d[0].concat([
                            d[1]
                        ])
                ...
                },
                {
                    ...
                    "postprocess": (x)=>(0, lexer_2.box)(x, 'INNER JOIN')
                },
                {
                    "name": "select_join_op",
                    "symbols": [
                ...
                },
                {
                    ...
                    "postprocess": (x)=>(0, lexer_2.box)(x, 'CROSS JOIN')
                },
                {
                    "name": "select_join_op",
                    "symbols": [
                ...
                },
                {
                    ...
                    "postprocess": (x)=>(0, lexer_2.box)(x, 'LEFT JOIN')
                },
                {
                    "name": "select_join_op",
                    "symbols": [
                ...
                },
                {
                    ...
                    "postprocess": (x)=>(0, lexer_2.box)(x, 'RIGHT JOIN')
                },
                {
                    "name": "select_join_op",
                    "symbols": [
                ...
                },
                {
                    ...
                    "postprocess": (x)=>(0, lexer_2.box)(x, 'FULL JOIN')
                },
                {
                    "name": "select_join_op",
                    "symbols": [
                ...
                },
                {
                    ...
                    "postprocess": (x)=>(0, lexer_2.box)(x, 'all')
                },
                {
                ...
                },
                {
                    ...
                    "postprocess": (x)=>(0, lexer_2.box)(x, x[1] || 'distinct')
                },
                {
                    "name": "select_where",
                    "symbols": [
                ...
                },
                {
                    ...
                    "postprocess": (x, rej)=>{
                        const value1 = unwrap(x);
                        if (!Array.isArray(value1)) {
                            return (0, lexer_2.track)(x, value1);
                        }
                        if (value1.length != 2) {
                            return rej;
                        }
                        const a = unwrap(value1[0]);
                        const b = unwrap(value1[1]);
                ...
                {
                    "name": "select_skip$subexpression$1",
                    "symbols": [
                        "kw_nowait"
                    ],
                    "postprocess": (x)=>(0, lexer_2.track)(x, {
                ...
                },
                {
                    ...
                    "symbols": [
                        lexer_1.lexerAny.has("op_compare") ? {
                            type: "op_compare"
                        } : op_compare
                    ]
                },
                ...
                },
                {
                    ...
                    "symbols": [
                        lexer_1.lexerAny.has("ops_others") ? {
                            type: "ops_others"
                        } : ops_others
                    ]
                },
                ...
                },
                {
                    "name": "expr_add$macrocall$2$macrocall$2$subexpression$1",
                    "symbols": [
                        lexer_1.lexerAny.has("op_additive") ? {
                            type: "op_additive"
                        } : op_additive
                    ]
                },
                ...
                {
                    "name": "expr_function_call$ebnf$1",
                    "symbols": [
                        "expr_list_raw"
                    ],
                    "postprocess": id
                ...
                {
                    "name": "expr_call_within_group$subexpression$1",
                    "symbols": [
                        "kw_within",
                        lexer_1.lexerAny.has("kw_group") ? {
                            type: "kw_group"
                ...
                {
                    "name": "expr_call_within_group$subexpression$2",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_order") ? {
                            type: "kw_order"
                        } : kw_order,
                ...
                {
                    "name": "expr_call_within_group",
                    "symbols": [
                        "expr_call_within_group$subexpression$1",
                        "lparen",
                        "expr_call_within_group$subexpression$2",
                        "select_order_by_expr",
                        "rparen"
                    ],
                    "postprocess": (x)=>(0, lexer_2.track)(x, x[3])
                },
                {
                ...
                },
                {
                    ...
                    "symbols": [
                        lexer_1.lexerAny.has("op_not_like") ? {
                            type: "op_not_like"
                        } : op_not_like
                    ],
                ...
                },
                {
                    ...
                    "symbols": [
                        lexer_1.lexerAny.has("op_not_ilike") ? {
                            type: "op_not_ilike"
                        } : op_not_ilike
                    ],
                ...
                },
                {
                    ...
                    "symbols": [
                        lexer_1.lexerAny.has("op_member") ? {
                            type: "op_member"
                        } : op_member
                    ]
                },
                {
                    "name": "ops_member$subexpression$1",
                    "symbols": [
                        lexer_1.lexerAny.has("op_membertext") ? {
                            type: "op_membertext"
                        } : op_membertext
                    ]
                },
                ...
                },
                {
                    ...
                    "postprocess": (x)=>(0, lexer_2.box)(x, toStr(x))
                },
                {
                    "name": "value_keyword",
                    "symbols": [
                ...
                {
                    "name": "createtable_references$ebnf$1",
                    "symbols": []
                },
                {
                    "name": "createtable_references$ebnf$1",
                    "symbols": [
                        "createtable_references$ebnf$1",
                ...
                {
                    "name": "createindex_statement$ebnf$5$subexpression$1",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_using") ? {
                            type: "kw_using"
                        } : kw_using,
                ...
                },
                {
                    ...
                    "symbols": [
                        "createindex_statement$ebnf$5$subexpression$1"
                    ],
                    "postprocess": id
                },
                {
                ...
                {
                    "name": "createindex_statement$ebnf$8",
                    "symbols": [
                ...
                {
                    "name": "simplestatements_set_names",
                    "symbols": [
                        "kw_names",
                ...
                {
                    "name": "simplestatements_set_names_val$subexpression$1",
                    "symbols": [
                        "string"
                    ]
                },
                {
                    "name": "simplestatements_set_names_val",
                    "symbols": [
                        "simplestatements_set_names_val$subexpression$1"
                    ],
                    "postprocess": (x)=>(0, lexer_2.track)(x, {
                            type: 'value',
                            value: unwrap(x[0])
                ...
                {
                    "name": "simplestatements_set_simple$ebnf$1$subexpression$1",
                    "symbols": [
                        "kw_local"
                    ]
                },
                ...
                {
                    "name": "simplestatements_set_simple$ebnf$1",
                    "symbols": [
                        "simplestatements_set_simple$ebnf$1$subexpression$1"
                    ],
                    "postprocess": id
                },
                {
                ...
                },
                {
                    ...
                    "symbols": [
                        "simplestatements_set_simple$ebnf$1",
                        "ident",
                ...
                {
                    "name": "update_statement$ebnf$1$subexpression$1",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_from") ? {
                            type: "kw_from"
                        } : kw_from,
                ...
                },
                {
                    ...
                    "symbols": [
                        "update_statement$ebnf$1$subexpression$1"
                    ],
                    "postprocess": id
                },
                {
                ...
                {
                    "name": "update_statement$ebnf$3$subexpression$1",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_returning") ? {
                            type: "kw_returning"
                        } : kw_returning,
                ...
                {
                    "name": "update_statement$ebnf$3",
                    "symbols": [
                        "update_statement$ebnf$3$subexpression$1"
                    ],
                    "postprocess": id
                },
                {
                ...
                {
                    "name": "altertable_drop_column$ebnf$3$subexpression$1",
                    "symbols": [
                        "kw_restrict"
                    ]
                },
                ...
                {
                    "name": "altertable_drop_column$ebnf$3",
                    "symbols": [
                        "altertable_drop_column$ebnf$3$subexpression$1"
                    ],
                    "postprocess": id
                },
                {
                ...
                {
                    "name": "altercol_generated$ebnf$3$subexpression$1",
                    "symbols": [
                        lexer_1.lexerAny.has("kw_as") ? {
                            type: "kw_as"
                        } : kw_as,
                ...
                {
                    "name": "altercol_generated$ebnf$3",
                    "symbols": [
                        "altercol_generated$ebnf$3$subexpression$1"
                    ],
                    "postprocess": id
                },
                {
                ...
                {
                    "name": "altercol_generated$ebnf$4$subexpression$1",
                    "symbols": [
                        "lparen",
                ...
                {
                    "name": "altercol_generated$ebnf$4",
                    "symbols": [
                        "altercol_generated$ebnf$4$subexpression$1"
                    ],
                    "postprocess": id
                },
                {
                ...
                {
                    "name": "altercol_generated$ebnf$5$subexpression$1",
                    "symbols": [
                        "kw_stored"
                    ]
                },
                {
                    "name": "altercol_generated$ebnf$5",
                    "symbols": [
                        "altercol_generated$ebnf$5$subexpression$1"
                    ],
                    "postprocess": id
                },
                {
                ...
                },
                {
                    ...
                    "symbols": [
                        ...
                        "altercol_generated$ebnf$3",
                        "altercol_generated$ebnf$4",
                        "altercol_generated$ebnf$5"
                    ],
                    "postprocess": (x)=>(0, lexer_2.track)(x, {
                            type: 'add generated',
                            ...x[1] && {
                ...
                {
                    "name": "alterindex_statement$ebnf$1",
                    "symbols": [
                        "kw_ifexists"
                    ],
                    "postprocess": id
                ...
                {
                    "name": "alterindex_statement",
                    "symbols": [
                        "kw_alter",
                        "kw_index",
                        "alterindex_statement$ebnf$1",
                        "table_ref",
                        "alterindex_action"
                    ],
                    "postprocess": (x)=>(0, lexer_2.track)(x, {
                ...
                {
                    "name": "alterindex_set_tablespace",
                    "symbols": [
                        "kw_set",
                        "kw_tablespace",
                        "word"
                ...
                {
                    "name": "delete_truncate$ebnf$2$subexpression$1",
                    "symbols": [
                        "kw_restrict"
                    ]
                },
                ...
                {
                    "name": "delete_truncate$ebnf$2",
                    "symbols": [
                        "delete_truncate$ebnf$2$subexpression$1"
                    ],
                    "postprocess": id
                },
                {
                ...
                },
                {
                    ...
                    "postprocess": (x)=>(0, lexer_2.box)(x, 'no minvalue')
                },
                {
                ...
                },
                {
                    ...
                    "postprocess": (x)=>(0, lexer_2.box)(x, 'no maxvalue')
                },
                {
                ...
                },
                {
                    ...
                    "postprocess": (x)=>(0, lexer_2.box)(x, unwrap(last(x)))
                },
                {
                ...
                },
                {
                    ...
                    "postprocess": (x)=>(0, lexer_2.box)(x, [
                            'restart',
                            typeof (0, lexer_2.unbox)(x[1]) === 'number' ? (0, lexer_2.unbox)(x[1]) : true
                        ])
                },
                {
                ...
                {
                    "name": "altertype_statement$subexpression$1",
                    "symbols": [
                        "altertype_enum_add_value"
                    ]
                },
                {
                    "name": "altertype_statement$subexpression$1",
                    "symbols": [
                        "altertype_enum_rename"
                    ]
                },
                {
                    "name": "altertype_statement",
                    "symbols": [
                        "kw_alter",
                        "kw_type",
                        "qualified_name",
                        "altertype_statement$subexpression$1"
                    ],
                    "postprocess": (x)=>(0, lexer_2.track)(x, {
                            name: x[2],
                            ...unwrap(x[3])
                ...
                {
                    "name": "altertype_enum_add_value",
                    "symbols": [
                        "kw_add",
                        "kw_value",
                        "enum_additional_value"
                    ],
                    "postprocess": (x)=>(0, lexer_2.track)(x, {
                            type: 'alter enum',
                            change: {
                ...
                },
                {
                    ...
                    "postprocess": (x)=>(0, lexer_2.track)(x, asName(x[0]))
                },
                {
                    "name": "deallocate_all",
                    "symbols": [
                ...
                },
                {
                    ...
                    "symbols": [
                        lexer_1.lexerAny.has("codeblock") ? {
                            type: "codeblock"
                        } : codeblock
                    ]
                },
                ...
                },
                {
                    ...
                    "symbols": [
                        lexer_1.lexerAny.has("semicolon") ? {
                            type: "semicolon"
                        } : semicolon
                    ]
                },
        ...
        const grammar = {
            ...
            ParserRules: [
                ...
                },
                {
                    "name": "main",
                    "symbols": [
                        array_lexer_1.lexerAny.has("start_list") ? {
                            type: "start_list"
                        } : start_list,
                        "main$ebnf$1",
                        array_lexer_1.lexerAny.has("end_list") ? {
                            type: "end_list"
                        } : end_list
                    ],
                    "postprocess": (x)=>x[1] || []
                ...
                },
                {
                    ...
                    "symbols": [
                        array_lexer_1.lexerAny.has("comma") ? {
                            type: "comma"
                        } : comma,
                        "elt"
                    ],
                ...
                },
                {
                    "name": "elt",
                    "symbols": [
                        array_lexer_1.lexerAny.has("value") ? {
                            type: "value"
                        } : value
                    ],
    ...
    function(module, exports1, __webpack_require__) {
        ...
        exports1.lexerAny = exports1.lexer = void 0;
        const moo_1 = __webpack_require__(0);
        // build lexer
        exports1.lexer = (0, moo_1.compile)({
            valueString: {
        ...
        exports1.lexer.next = ((next)=>()=>{
                let tok;
                while((tok = next.call(exports1.lexer)) && tok.type === 'space'){}
                return tok;
            })(exports1.lexer.next);
        exports1.lexerAny = exports1.lexer;
    /***/ },
        ...
        const grammar = {
            ...
            ParserRules: [
                ...
                },
                {
                    "name": "float",
                    "symbols": [
                        geometric_lexer_1.lexerAny.has("float") ? {
                            type: "float"
                        } : float
                    ],
                    "postprocess": (args)=>parseFloat(unwrap(args))
                },
                {
                    "name": "int",
                    "symbols": [
                        geometric_lexer_1.lexerAny.has("int") ? {
                            type: "int"
                        } : int
                    ],
                    "postprocess": (arg)=>parseInt(unwrap(arg), 10)
                },
                {
                    "name": "comma",
                    "symbols": [
                        geometric_lexer_1.lexerAny.has("comma") ? {
                            type: "comma"
                        } : comma
                    ],
                    "postprocess": id
                ...
                },
                {
                    "name": "point$macrocall$1$subexpression$1",
                    "symbols": [
                        geometric_lexer_1.lexerAny.has("lparen") ? {
                            type: "lparen"
                        } : lparen,
                        "point$macrocall$2",
                        geometric_lexer_1.lexerAny.has("rparen") ? {
                            type: "rparen"
                        } : rparen
                    ],
                    "postprocess": get(1)
                ...
                },
                {
                    "name": "line",
                    "symbols": [
                        geometric_lexer_1.lexerAny.has("lcurl") ? {
                            type: "lcurl"
                        } : lcurl,
                        "number",
                        "comma",
                        ...
                        "comma",
                        "number",
                        geometric_lexer_1.lexerAny.has("rcurl") ? {
                            type: "rcurl"
                        } : rcurl
                    ],
                    "postprocess": (x)=>({
                ...
                },
                {
                    ...
                    "symbols": [
                        geometric_lexer_1.lexerAny.has("lbracket") ? {
                            type: "lbracket"
                        } : lbracket
                    ]
                },
                {
                    ...
                    "symbols": [
                        geometric_lexer_1.lexerAny.has("rbracket") ? {
                            type: "rbracket"
                        } : rbracket
                    ]
                },
                ...
                },
                {
                    ...
                    "symbols": [
                        geometric_lexer_1.lexerAny.has("lcomp") ? {
                            type: "lcomp"
                        } : lcomp
                    ]
                },
                {
                    ...
                    "symbols": [
                        geometric_lexer_1.lexerAny.has("rcomp") ? {
                            type: "rcomp"
                        } : rcomp
                    ]
                },
        ...
        const grammar = {
            ...
            ParserRules: [
                ...
                },
                {
                    "name": "unit",
                    "symbols": [
                        interval_lexer_1.lexerAny.has("years") ? {
                            type: "years"
                        } : years
                    ]
                },
                {
                    "name": "unit",
                    "symbols": [
                        interval_lexer_1.lexerAny.has("months") ? {
                            type: "months"
                        } : months
                    ]
                },
                {
                    "name": "unit",
                    "symbols": [
                        interval_lexer_1.lexerAny.has("days") ? {
                            type: "days"
                        } : days
                    ]
                },
                {
                    "name": "unit",
                    "symbols": [
                        interval_lexer_1.lexerAny.has("hours") ? {
                            type: "hours"
                        } : hours
                    ]
                },
                {
                    "name": "unit",
                    "symbols": [
                        interval_lexer_1.lexerAny.has("minutes") ? {
                            type: "minutes"
                        } : minutes
                    ]
                },
                {
                    "name": "unit",
                    "symbols": [
                        interval_lexer_1.lexerAny.has("seconds") ? {
                            type: "seconds"
                        } : seconds
                    ]
                },
                {
                    "name": "unit",
                    "symbols": [
                        interval_lexer_1.lexerAny.has("milliseconds") ? {
                            type: "milliseconds"
                        } : milliseconds
                    ]
                },
                ...
                },
                {
                    "name": "uint",
                    "symbols": [
                        interval_lexer_1.lexerAny.has("int") ? {
                            type: "int"
                        } : int
                    ],
                ...
                },
                {
                    ...
                    "symbols": [
                        interval_lexer_1.lexerAny.has("neg") ? {
                            type: "neg"
                        } : neg
                    ]
                },
                ...
                },
                {
                    ...
                    "postprocess": ([neg1, x])=>parseInt(x, 10) * (neg1 ? -1 : 1)
                },
                {
                ...
                },
                {
                    ...
                    "symbols": [
                        "float$ebnf$1",
                        "float$ebnf$2",
                        interval_lexer_1.lexerAny.has("dot") ? {
                            type: "dot"
                        } : dot,
                        interval_lexer_1.lexerAny.has("int") ? {
                            type: "int"
                    ...
                    "postprocess": ([neg1, ...v])=>parseFloat(v.map((v)=>v ? v.text : '0').join('')) * (neg1 ? -1 : 1)
                },
                {
                    "name": "time$ebnf$1$subexpression$1",
                    "symbols": [
                        interval_lexer_1.lexerAny.has("colon") ? {
                            type: "colon"
                        } : colon,
                        "uint"
                    ]
            ...
            ParserRules: [
                {
                    "name": "num",
                    "symbols": [
                        interval_iso_lexer_1.lexerAny.has("int") ? {
                            type: "int"
                        } : int
                    ]
                },
                {
                    "name": "num",
                    "symbols": [
                        interval_iso_lexer_1.lexerAny.has("float") ? {
                            type: "float"
                        } : float
                    ]
                },
                ...
                },
                {
                    "name": "main$ebnf$2$subexpression$1",
                    "symbols": [
                        interval_iso_lexer_1.lexerAny.has("T") ? {
                            type: "T"
                        } : T,
                        "main$ebnf$2$subexpression$1$ebnf$1"
                    ]
                ...
                },
                {
                    "name": "main",
                    "symbols": [
                        interval_iso_lexer_1.lexerAny.has("P") ? {
                            type: "P"
                        } : P,
                        "main$ebnf$1",
                        "main$ebnf$2"
                ...
                },
                {
                    ...
                    "symbols": [
                        interval_iso_lexer_1.lexerAny.has("Y") ? {
                            type: "Y"
                        } : Y
                    ]
                },
                {
                    "name": "long$subexpression$1",
                    "symbols": [
                        interval_iso_lexer_1.lexerAny.has("M") ? {
                            type: "M"
                        } : M
                    ]
                },
                {
                    "name": "long$subexpression$1",
                    "symbols": [
                        interval_iso_lexer_1.lexerAny.has("W") ? {
                            type: "W"
                        } : W
                    ]
                },
                {
                    "name": "long$subexpression$1",
                    "symbols": [
                        interval_iso_lexer_1.lexerAny.has("D") ? {
                            type: "D"
                        } : D
                    ]
                },
                ...
                },
                {
                    ...
                    "symbols": [
                        interval_iso_lexer_1.lexerAny.has("H") ? {
                            type: "H"
                        } : H
                    ]
                },
                ...
                },
                {
                    "name": "short$subexpression$1",
                    "symbols": [
                        interval_iso_lexer_1.lexerAny.has("S") ? {
                            type: "S"
                        } : S
                    ]
                },
    ...
    function(module, exports1, __webpack_require__) {
        ...
        const visitor = (0, ast_visitor_1.astVisitor)((m)=>({
                ...
                raise: (r)=>{
                    ...
                    if ((_b = r.using) === null || _b === void 0 ? void 0 : _b.length) {
                        ret.push(' USING ');
                        list(r.using, ({ type, value: value1 })=>{
        ...
        for (const k of Object.getOwnPropertyNames(proto)){
            ...
            exports1.toSql[k] = function(...args) {
                try {
    ...
    function(module, exports1, __webpack_require__) {
        ...
        exports1.locationOf = locationOf;
        ;
        ;
    /***/ }
]));
...
//# sourceMappingURL=node_modules_pgsql-ast-parser_index_1pel5mo.js.map